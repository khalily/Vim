...
highlight Normal guibg=black ctermbg=16
else
highlight Normal guibg=black ctermbg=16
endif
...
highlight Ignore
highlight WildMenu guifg=black guibg=#ffff00 gui=bold ctermfg=16 ctermbg=226
"cterm=bold
...
highlight ErrorMsg guifg=NONE guibg=red ctermbg=196
highlight Search guifg=NONE gui=NONE cterm=NONE
...
highlight LineNr guifg=#ddeeff ctermfg=255
...
highlight DiffAdd guibg=darkblue ctermbg=18
highlight DiffChange guibg=darkmagenta ctermbg=90
...
highlight Pmenu guifg=white gui=bold ctermfg=231 cterm=bold
highlight PmenuSel guifg=white gui=bold ctermfg=231 cterm=bold
